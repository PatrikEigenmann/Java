	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					/*
					 * If you want to see all messages in the log, just type LogManager.ALL. For
					 * combinations, type LogManager.INFO | LogManager.ERROR.
					 */
					LogManager.setFlag(LogManager.WARNING);
=======
 * -----------------------------------------------------------------------------------------------------------
 * To Do:
 * Implementing a Configuration System.																-> Done
